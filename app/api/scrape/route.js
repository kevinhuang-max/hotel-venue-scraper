...
function isRelevantUrl(url) {
        ...
        const skipPatterns = [
                    'privacy', 'terms', 'cookie', 'careers', 'jobs', 'press', 'news', 
                    'blog', 'contact', 'about-us', 'faq', 'help', 'support', 'login',
                    'signin', 'signup', 'cart', 'checkout', 'booking', 'reservation',
                    'gallery', 'photo', 'video', 'media', 'sitemap', 'legal'
                ];
